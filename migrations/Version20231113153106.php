 ...
 */
final class Version20231113153106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD organisateur_id INT NOT NULL, ADD is_published TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie DROP organisateur_id, DROP is_published');
    }
}
